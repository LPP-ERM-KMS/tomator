    ...
    for (int im = 0; im < NMESHP; ++im) {
        ...
        if (bH) {
            if (nH2 > 0.0) // Go through this only when Hydrogen is present
            {
                ...
                // 3.) 3-body recombination (e + e + H+ -> e + H)
                if (bH_3body) {
                    if (Te > 0.6) {
                        // Need ionization rate k for 3-body rate calculation [170.8160 = 4.0*3.14*13.6]
                        double k_ion = 2.91e-8 * pow((13.6 / Te), 0.39) * exp(-13.6 / Te) / (0.232 + 13.6 / Te);
                        k = 1.4804e-25 * pow((170.8160 / Te), 1.5) * exp(13.6 / Te) * k_ion * ndamp(nHi);
                        knn = k * ne * ne * nHi;
                        dnHi += -knn;
                        dnH += +knn;
                        dne += -knn;
        ...
        if (bH2) {
            if (nH2 > 0.0) {
                ...
                if (bH2_elas) {
                    ...
                    knn = k * ne * nH2;
                    L2 = 4.0 * me * (2.0 * mi) / pow(me + (2.0 * mi), 2.0); // Langevins energy loss parameter
        ...
        if (bHe) {
            if (nHeI > 0.0) {
                ...
                if (bHeI_ion) {
                    k = RRHe(IHE1, ne, Te) * ndamp(nHeI); // cout << "   " << k ;
                    knn = k * ne * nHeI;
                    dnHeI += -knn;
                    dnHeII += +knn;
                    dne += +knn;
                ...
                if (bHeII_ion) {
                    k = RRHe(IHE2, ne, Te) * ndamp(nHeII); // cout << "   " << k ;
                    knn = k * ne * nHeII;
...
exp3=( HeIIIa1*pow(Tx,HeIIIa2)+HeIIIa3*pow(Tx,HeIIIa4)+HeIIIa5*pow(Tx,HeIIIa6) )*1.0e-33*1.0e6; //Wcm3 */
                ...
                if (bHeII_rec) {
                    k = RRHe(RHE2, ne, Te) * ndamp(nHeII); //  *  pow(1.0+1.0e1/nHeII+1.0e1/ne,-0.66) ; // cout << "   " << k ;//25/04/2017
                    knn = k * ne * nHeII;
                    ...
                    dEe += -knn * Te * 0.667 * (3.0 / 2.0 + // 20220603 hydhel -. based on H+ reco
                                                (log(k) - log(RRHe(RHE2, ne, 0.99 * Te) * ndamp(nHeII))) / (log(Te) - log(0.99 * Te)));
                ...
                if (bHeIII_rec) {
                    k = RRHe(RHE3, ne, Te) * ndamp(nHeIII); //  *  pow(1.0+1.0e1/nHeIII+1.0e1/ne,-0.66) ; // cout << "   " << k << endl; //25/04/2017
                    knn = k * ne * nHeIII;
                    dnHeII += +knn; // cout << "   " << dnHeII ;
                    dnHeIII += -knn;
                    dne += -knn;
                    ...
                    // dEe     +=    - knn*Te/3.0; // added 20/02/2014
                    dEe += -knn * Te * 0.667 * (3.0 / 2.0 + // 20220603 hydhel -. based on H+ reco
                                                (log(k) - log(RRHe(RHE3, ne, 0.99 * Te) * ndamp(nHeIII))) / (log(Te) - log(0.99 * Te)));
        ...
        if (bion) {
            ...
            if (bion_HiH2i_326) {
                ...
                nuHi = nuHi + k * nH2i; // corrected 20260108
                nuH2i = nuH2i + k * nHi;
            }
            // Reaction 4.2.1
        ...
        if (belas) {
            ...
            if (belas_H2iH) {
                ...
                L2 = 4.0 * mi * (2.0 * mi) / pow(mi + (2.0 * mi), 2.0); // Langevins energy loss parameter
                knn = k * nH2i * nH;
            ...
            if (belas_H3iH) {
                ...
                L2 = 4.0 * mi * (3.0 * mi) / pow(mi + (3.0 * mi), 2.0); // Langevins energy loss parameter
                knn = k * nH3i * nH;
            ...
            if (belas_HeIIH) {
                ...
                L2 = 4.0 * mi * (4.0 * mi) / pow(mi + (4.0 * mi), 2.0); // Langevins energy loss parameter
                knn = k * nHeII * nH;
            ...
            if (belas_H2iH2) {
                ...
                L2 = 1.0; // Langevins energy loss parameter
                knn = k * nH2i * nH2;
            ...
            if (belas_H3iH2) {
                ...
                L2 = 4.0 * (3.0 * mi) * (2.0 * mi) / pow((3.0 * mi) + (2.0 * mi), 2.0); // Langevins energy loss parameter
                knn = k * nH3i * nH2;
            ...
            if (belas_HeIIH2) {
                ...
                L2 = 4.0 * (4.0 * mi) * (2.0 * mi) / pow((4.0 * mi) + (2.0 * mi), 2.0); // Langevins energy loss parameter
                knn = k * nHeII * nH2;
        ...
        if (bcoulomb) {
            ...
            if ((nHi * nH2i) != 0.0) {
                ...
                if (lambda12 < 10.0) { lambda12 = 10.0; } else if (lambda12 > 20.0) { lambda12 = 20.0; }
            ...
            if ((nHi * nH3i) != 0.0) {
                ...
                if (lambda13 < 10.0) { lambda13 = 10.0; } else if (lambda13 > 20.0) { lambda13 = 20.0; }
            ...
            if ((nHi * nHeII) != 0.0) {
                ...
                if (lambda14 < 10.0) { lambda14 = 10.0; } else if (lambda14 > 20.0) { lambda14 = 20.0; }
            ...
            if ((nHi * nHeIII) != 0.0) {
                ...
                if (lambda15 < 10.0) { lambda15 = 10.0; } else if (lambda15 > 20.0) { lambda15 = 20.0; }
            ...
            if ((nH2i * nH3i) != 0.0) {
                ...
                if (lambda23 < 10.0) { lambda23 = 10.0; } else if (lambda23 > 20.0) { lambda23 = 20.0; }
            ...
            if ((nH2i * nHeII) != 0.0) {
                ...
                if (lambda24 < 10.0) { lambda24 = 10.0; } else if (lambda24 > 20.0) { lambda24 = 20.0; }
            ...
            if ((nH2i * nHeIII) != 0.0) {
                ...
                if (lambda25 < 10.0) { lambda25 = 10.0; } else if (lambda25 > 20.0) { lambda25 = 20.0; }
            ...
            if ((nH3i * nHeII) != 0.0) {
                ...
                if (lambda34 < 10.0) { lambda34 = 10.0; } else if (lambda34 > 20.0) { lambda34 = 20.0; }
            ...
            if ((nH3i * nHeIII) != 0.0) {
                ...
                if (lambda35 < 10.0) { lambda35 = 10.0; } else if (lambda35 > 20.0) { lambda35 = 20.0; }
            ...
            if ((nHeII * nHeIII) != 0.0) {
                ...
                if (lambda45 < 10.0) { lambda45 = 10.0; } else if (lambda45 > 20.0) { lambda45 = 20.0; }
